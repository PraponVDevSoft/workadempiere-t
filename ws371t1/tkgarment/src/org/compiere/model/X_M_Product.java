...
public class X_M_Product extends PO implements I_M_Product, I_Persistent 
{
	 ...
	 *
	 */
	private static final long serialVersionUID = 25550911L;
...
// I
	...
	/** Set End Job.
		...
		This is end job
	  */
	public void setIsEndJob (boolean IsEndJob)
	{
		set_Value (COLUMNNAME_IsEndJob, Boolean.valueOf(IsEndJob));
	}

	/** Get End Job.
		@return This is end job
	  */
	public boolean isEndJob () 
	{
		Object oo = get_Value(COLUMNNAME_IsEndJob);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** Set Finish Product (Model).
		@param IsFinishProduct 
		เป็นการระบุว่ารายการนี้ี้เป็นรุ่นงานหรือสิ่งที่ต้องผลิต
	  */
	public void setIsFinishProduct (boolean IsFinishProduct)
	{
		set_Value (COLUMNNAME_IsFinishProduct, Boolean.valueOf(IsFinishProduct));
	}

	/** Get Finish Product (Model).
		@return เป็นการระบุว่ารายการนี้ี้เป็นรุ่นงานหรือสิ่งที่ต้องผลิต
	  */
	public boolean isFinishProduct () 
	{
		Object oo = get_Value(COLUMNNAME_IsFinishProduct);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** Set Brand.
		@param M_Brand_ID 
		Product or Material Brand Name
	  */
	...
	/** Get Brand.
		@return Product or Material Brand Name
	  */
