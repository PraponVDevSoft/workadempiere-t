...
// @#Date@
	...
	public org.compiere.model.I_C_UOM getC_UOM_Purchase() throws RuntimeException
    {
		return (org.compiere.model.I_C_UOM)MTable.get(getCtx(), org.compiere.model.I_C_UOM.Table_Name)
			.getPO(getC_UOM_Purchase_ID(), get_TrxName());	}

	/** Set Purchase Unit.
		@param C_UOM_Purchase_ID Purchase Unit	  */
	public void setC_UOM_Purchase_ID (int C_UOM_Purchase_ID)
	{
		if (C_UOM_Purchase_ID < 1) 
			set_Value (COLUMNNAME_C_UOM_Purchase_ID, null);
		else 
			set_Value (COLUMNNAME_C_UOM_Purchase_ID, Integer.valueOf(C_UOM_Purchase_ID));
	}

	/** Get Purchase Unit.
		@return Purchase Unit	  */
	public int getC_UOM_Purchase_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_C_UOM_Purchase_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set Qty Purchase.
		@param QtyPurchase Qty Purchase	  */
	public void setQtyPurchase (BigDecimal QtyPurchase)
	{
		set_Value (COLUMNNAME_QtyPurchase, QtyPurchase);
	}
	...
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_QtyPurchase);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
