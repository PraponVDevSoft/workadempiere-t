...
//			String sql = "SELECT COALESCE(MAX(Line),0)+10 FROM C_OrderLine WHERE C_Order_ID=?";
			String sql = "SELECT COALESCE(MAX(Line),0)+1 FROM C_OrderLine WHERE C_Order_ID=?";
	...
	public boolean equals(Object cmp) {
		...
		MOrderLine otherLine = (MOrderLine)cmp;
		return ((this.getM_Product_ID() == otherLine.getM_Product_ID()) 
				&& (this.getM_AttributeSetInstance_ID() == otherLine.getM_AttributeSetInstance_ID()) );
